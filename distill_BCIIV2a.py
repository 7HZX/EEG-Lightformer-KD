...
class ExP():
    def __init__(self, nsub):
        ...
        self.start_epoch = 0
        self.root = "../datasets/downstream/Data/strict_TE/"

        self.log_write = open("conformer_log_subject%d.txt" % self.nSub, "w")
        ...
        from linear_probe_EEGPT_BCIC2A import LitEEGPTCausal
        ...
        self.conv1 = nn.Conv1d(in_channels=22, out_channels=19, kernel_size=1)
        self.conv1.cuda()
...
def main():
    best = 0
    aver = 0
    result_write = open("sub_result_confomer.txt", "w")
