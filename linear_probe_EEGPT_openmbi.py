...
class LitEEGPTCausal(pl.LightningModule):
    ...
    def __init__(self, load_path="../checkpoint/eegpt_mcae_58chs_4s_large4E.ckpt"):
        ...
        self.chan_conv = Conv1dWithConstraint(20, self.chans_num, 1, max_norm=1)
...
if __name__ == "__main__":
    ...
    data_path = "/mnt/d/work/jd/distill/EEGPT/EEGPT-main/datasets/downstream/Data/BCIC_2a_0_38HZ"
    import math
    ...
    for i in range(1, 10):
        ...
        train_loader = torch.utils.data.DataLoader(train_dataset, batch_size=batch_size, num_workers=0, shuffle=False)
        ...
        trainer = pl.Trainer(accelerator='cuda',
                             ...
                             logger=[
                                 pl_loggers.TensorBoardLogger('./logs/', name="EEGPT_BCIC2A_tb", version=f"subject{i}"),
